...
export function ResetPasswordPage() {
  ...
  const handleSubmit = async (event: React.FormEvent) => {
    ...
    try {
      ...
      let message = 'Failed to reset password. Please request a new reset link.';
    ...
    <div className="min-h-screen bg-slate-50 flex items-center justify-center p-4">
      <div className="max-w-md w-full bg-white rounded-3xl shadow-sm border border-slate-100 p-8">
        ...
        <div className="text-center mb-6">
          <h2 className="text-xl font-bold text-slate-800 tracking-tight">Reset your password</h2>
